/** biome-ignore-all lint/correctness/noInnerDeclarations: <arquivo importado> */
/** biome-ignore-all lint/suspicious/noApproximativeNumericConstant: <arquivo importado> */
/** biome-ignore-all lint/complexity/noCommaOperator: <arquivo importado> */
/** biome-ignore-all lint/style/useTemplate: <arquivo importado> */
/** biome-ignore-all lint/suspicious/noAssignInExpressions: <arquivo importado> */
var _cc = (() => {
	function t(t, i) {
	...
	return (i, s, e) => (s && t(i.prototype, s), e && t(i, e), i);
})();
function _ccc(t, i) {
	if (!(t instanceof i))
...
!((t) => {
	...
	// biome-ignore lint/correctness/noUnusedVariables: <funciona>
	var e = (() => {
			function t(i, e, h) {
				_ccc(this, t),
					(this.o = h),
			...
			return (
				_cc(t, [
					...
					{ key: "grd", value: () => (Math.random() > 0.5 ? 1 : -1) },
					{
						key: "grs",
						value: function () {
		...
		h = (() => {
			function h(i) {
				...
				if (!document.querySelector('canvas[theme="dark"]')) {
					console.log("tá achando o homem ae");

					_ccc(this, h),
						(this.c = document.createElement("canvas")),
						(this.x = this.c.getContext("2d")),
						this.c.setAttribute("id", "finisher-canvas"),
						this.c.setAttribute("theme", "dark"),
						this.gr(i.className).appendChild(this.c);
					var e = void 0;
					t.addEventListener(
						"resize",
						() => {
							clearTimeout(e), (e = setTimeout(this.resize.bind(this), 150));
						},
						!1,
					),
						this.init(i),
						t.requestAnimationFrame(this.an.bind(this));
				} else if (!document.querySelector('canvas[theme="light"]')) {
					console.log("tá achando a muié ae");

					_ccc(this, h),
						(this.c = document.createElement("canvas")),
						(this.x = this.c.getContext("2d")),
						this.c.setAttribute("id", "finisher-canvas"),
						this.c.setAttribute("theme", "light"),
						this.gr(i.className).appendChild(this.c);
					// biome-ignore lint/suspicious/noRedeclare: <funciona>
					var e = void 0;
					t.addEventListener(
						"resize",
						() => {
				...
				_cc(h, [
					{
						...
						value: (t) => {
							var i;
							const darkDiv = document.querySelector(".finisher-header-dark");
							const lightDiv = document.querySelector(".finisher-header-light");

							if (darkDiv.children.length === 0) {
								i = document.getElementsByClassName(
									t || "finisher-header-dark",
								);
							} else if (lightDiv.children.length === 0) {
								i = document.getElementsByClassName(
									t || "finisher-header-light",
								);
							} else {
								i = document.getElementsByClassName(
									t || "finisher-header-dark",
